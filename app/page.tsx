  ...
  return (
    <section className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
      ...
      <div className="relative h-full mx-auto max-w-6xl px-5 sm:px-6 flex flex-col items-center justify-center text-center text-cream">
        <span className={`inline-flex items-center gap-2 bg-primary text-ink rounded-md px-4 py-1.5 text-[11px] mb-7 ${kicker}`}>
        ...
        <h1 className={`font-display lowercase leading-[0.86] text-[clamp(3.5rem,12vw,9.5rem)] ${overlayShadow}`}>
          small spot.
          <br />
          <span className="text-primary">family owned.</span>
        </h1>

        <p className={`mt-7 text-cream text-xs sm:text-sm ${subtext} [text-shadow:0_1px_8px_rgba(0,0,0,0.6)]`}>
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`rounded-md bg-primary text-ink px-8 py-4 text-sm shadow-2xl shadow-black/40 hover:bg-primary-dark transition ${subtext}`}
          >
            Get Directions
          </a>
          <a
            href={business.phoneHref}
            className={`rounded-md bg-cream text-ink px-8 py-4 text-sm shadow-xl shadow-black/30 hover:bg-white transition ${subtext}`}
          >
            Call {business.phone}
          </a>
        </div>

        <p className={`mt-7 text-cream text-[11px] flex items-center gap-2 ${kicker} [text-shadow:0_1px_8px_rgba(0,0,0,0.6)]`}>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-6 py-28 md:py-40 text-center text-cream">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            href="/menu"
            className={`rounded-md bg-primary text-ink px-7 py-4 text-sm shadow-2xl shadow-black/40 hover:bg-primary-dark transition ${subtext}`}
          >
            See the Menu
          </Link>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className={`rounded-md bg-cream text-ink px-7 py-4 text-sm shadow-xl shadow-black/30 hover:bg-white transition ${subtext}`}
          >
            Get Directions
          </a>
        </div>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-6 py-28 md:py-40 text-center text-cream">
        ...
        <h2 className={`font-display lowercase mt-6 leading-[0.82] text-[clamp(4rem,17vw,13rem)] ${overlayShadow}`}>
          street tacos
          <br />
          <span className="text-primary">{tacoTuesday.price}</span>
        </h2>
    ...
    <section className="bg-paper">
      <div className="mx-auto max-w-7xl px-5 sm:px-6 py-20 md:py-28 text-center">
        ...
        <div className="mt-12 grid grid-cols-3 gap-2 md:gap-3">
          {tiles.map((t) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="relative aspect-square overflow-hidden bg-ink group"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`mt-12 inline-flex items-center gap-3 rounded-md bg-ink text-cream px-8 py-4 text-sm hover:bg-primary hover:text-ink transition ${subtext}`}
        >
